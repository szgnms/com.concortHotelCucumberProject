...
public class ReusableMethods {
    ...
    public static void switchWindowIndex(Integer targetIndex){
        ArrayList<String> tumsayfalarhash =new ArrayList<>(Driver.getDriver().getWindowHandles());
        Driver.getDriver().switchTo().window(tumsayfalarhash.get(targetIndex));
        }
...
//   waitFor(5);  => waits for 5 second
    ...
    public static void dropDownMenuId(String byId,Integer selectIndex ){
        WebElement ddm=Driver.getDriver().findElement(By.id(byId));
        Select select=new Select(ddm);
        select.selectByIndex(selectIndex);
    }

    public static void dropDownMenuXpath(String byxpath,Integer selectIndex ){
